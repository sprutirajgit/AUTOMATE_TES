...
public class Comp30days {
	static Logger log = LogManager.getLogger(Comp30days.class);
	@Test(priority=2)
	 		 ...
	 		 driver.findElement(By.xpath("/html/body/div[1]/div[1]/div/div/div[2]/div[3]/form/div[1]/div/input[1]")).sendKeys(" implementations@ken42.spj.staging");
	 			...
	 			Reporter.log("Clear the Extra API On the URI ",true);
	 			 ...
	 			 Reporter.log("on the api Testing Here We fillter the Exam Complete the 30 days ",true);
	 				...
	 				log.info("To show the Response came from Salesforce & the record count 30");
	 				 Reporter.log("To show the Response came from Salesforce & the record count 30 ",true);
