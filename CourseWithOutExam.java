...
public class CourseWithOutExam {
	static Logger log = LogManager.getLogger(CourseWithOutExam.class);
	@Test(priority=2)
	public void CourseWithOut(Method method) throws InterruptedException {
		System.out.println("\n Welcome \n");
	     ...
	     WebDriverManager.chromedriver().setup();
			...
			Reporter.log( "Maximize the Browser", true );
	         ...
	         driver.findElement(By.xpath("//span[.='Exam Management']")).click();
	     		...
	     		System.out.println("No such Element Handle");
	     	}
	         Thread.sleep(1000);
	         ...
	         List<WebElement> row = driver.findElements(By.xpath("/html/body/div[1]/div/div/div/div[2]/div/div/div[4]/div[1]/div/div//table/tbody/tr"));
	         System.out.println("The number of Record  is from Portal on Course Without Exam Filletr "+ row.size());
	         log.info("The number of Record  is from Portal on Course Without Exam Filletr"+ row.size());
	 		...
	 		Reporter.log("Login to the WorkBench",true);
	 		 driver.findElement(By.xpath("/html/body/div[1]/div[1]/div/div/div[2]/div[3]/form/div[1]/div/input[1]")).sendKeys("implementations@ken42.spj.staging");
	 			...
	 			Reporter.log("Clear the Extra API On the URI ",true);
	 			 driver.findElement(By.xpath("/html/body/div[2]/form/input[2]")).sendKeys("/services/apexrest/CoursesWithoutExam");
	 			  log.info("on the api Testing Here  Course Without Exam Filletr");
	 			 Reporter.log("on the api Testing Here  Course Without Exam Filletr ",true);
	 				...
	 				log.info("[\r\n"
	 						+ "  {\r\n"
	 						+ "    \"termName\": \"2022-JAN-BBA-Term8-Sydeny\",\r\n"
	 						+ "    \"programName\": \"2022-JAN-BBA\",\r\n"
	 						+ "    \"id\": \"a241y000000LJX2AAO\",\r\n"
	 						+ "    \"courseName\": \"BBAFIN412-Trading and Portfolio Management\"\r\n"
	 						+ "  },\r\n"
	 						+ "  {\r\n"
	 						+ "    \"termName\": \"2023-JAN-GMBA-Term1-Dubai\",\r\n"
	 						+ "    \"programName\": \"2023-JAN-GMBA\",\r\n"
	 						+ "    \"id\": \"a241y000000LIgMAAW\",\r\n"
	 						+ "    \"courseName\": \"Commerce\"\r\n"
	 						+ "  },\r\n"
	 						+ "  {\r\n"
	 						+ "    \"termName\": \"BDS 2022 Fall Semester 5\",\r\n"
	 						+ "    \"programName\": null,\r\n"
	 						+ "    \"id\": \"a241y000000LHNwAAO\",\r\n"
	 						+ "    \"courseName\": \"BBAMGT106-Principles of Management\"\r\n"
	 						+ "  },\r\n"
