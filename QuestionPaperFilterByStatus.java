...
public class QuestionPaperFilterByStatus {
	static Logger log = LogManager.getLogger(QuestionPaperFilterByStatus.class);
	@Test(priority=2)
		...
		System.out.println("\n Welcome \n");
	     ...
	     WebDriverManager.chromedriver().setup();
			...
			Reporter.log( "Maximize the Browser", true );
	         ...
	         Thread.sleep(2000);
	         driver.findElement(By.xpath("(//span[.='View'])[1]")).click();
	         Thread.sleep(4000);
	       ...
	       driver.findElement(By.xpath("//li[.='Approved']")).click();
		 		 ...
		 		 driver.findElement(By.xpath("/html/body/div[1]/div[1]/div/div/div[2]/div[3]/form/div[1]/div/input[1]")).sendKeys("implementations@ken42.spj.staging");
		 			...
		 			Reporter.log("Clear the Extra API On the URI ",true);
		 			 ...
		 			 driver.findElement(By.xpath("/html/body/div[2]/form/input[2]")).sendKeys("/services/apexrest/QuestionPaper/?status=Approved");
		 			  log.info("on the api Testing Here We fillter The Question paper Status approved");
		 			 Reporter.log("on the api Testing Here We fillter The Question paper Status approved ",true);
